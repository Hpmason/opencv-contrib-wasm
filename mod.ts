import * as OpenCV from 'https://unpkg.com/@hpmason/opencv-contrib-wasm@4.5.3-0/types/opencv.ts';
import {cv as _cv} from 'https://unpkg.com/@hpmason/opencv-contrib-wasm@4.5.3-0/opencv-deno.js';
